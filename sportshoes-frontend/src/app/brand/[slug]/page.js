    ...
    <div className="min-h-screen bg-[#FAFAFA]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <div className="relative mb-10">
          <div className="absolute top-0 left-0 w-20 h-1 bg-gradient-to-r from-[#7C3AED] to-[#00FF88] rounded-full" />
          <div className="pt-4">
            <p className="text-xs font-semibold text-[#999999] uppercase tracking-wider mb-2">Marca</p>
